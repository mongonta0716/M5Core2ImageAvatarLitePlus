...
#define SDU_APP_PATH "/M5Core2AvatarLiteP.bin" // title for SD-Updater UI
#define SDU_APP_NAME "Image Avater Lite Plus" // title for SD-Updater UI
...
const char* avatar_system_json = "/json/M5AvatarLitePSystem.json"; // ファイル名は32バイトを超えると不具合が起きる場合あり
